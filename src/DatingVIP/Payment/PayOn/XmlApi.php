...
class XmlApi
{
    ...
    public function getTranResponseData($key = '')
    {
        ...
        $ret = [
            ...
            'c_amount'          => self::getString( $sxo->Transaction->Payment->Clearing->Amount ),
            ...
            'c_fx_rate'         => self::getString( $sxo->Transaction->Payment->Clearing->FxRate ),
            'c_fx_source'       => self::getString( $sxo->Transaction->Payment->Clearing->FxSource ),
            'c_fx_date'         => strtotime( self::getString( $sxo->Transaction->Payment->Clearing->FxDate )),
